...
function printFlowerOrder(data) {
    
}

function printFlowerMenu(data) {
    let flowerHTML;
...
function printData(name) {
    if (name === "flower-menu" || name === "flower-order") {
        ...
        .then((data) => {
            if (name === "flower-menu") {
                printFlowerMenu(data);
            }
            else if (name === "flower-order") {
                printFlowerOrder(data);
            }
        })
        .catch( (error) => {
            console.error(error);
